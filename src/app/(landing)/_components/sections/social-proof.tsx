...
export function SocialProofSection() {
  return (
    <div className="w-full border-b border-(--landing-border) flex flex-col justify-center items-center">
      <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-(--landing-border) flex justify-center items-center gap-6">
      ...
      <div className="self-stretch border-(--landing-border) flex justify-center items-start border-t border-b-0">
        ...
        <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-0 border-l border-r border-(--landing-border)">
